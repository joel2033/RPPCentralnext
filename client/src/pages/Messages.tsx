...
/**
 * Renders the Messages page: a two-pane messaging UI with a searchable conversations list and a message view for the selected conversation.
 *
 * The component displays conversations on the left, filters them by the search input, and shows messages for the selected conversation on the right. It resolves the current user from available auth contexts, fetches conversation and message data, and provides a form to compose and send new messages while keeping lists in sync.
 *
 * @returns The React element for the Messages page UI.
 */
