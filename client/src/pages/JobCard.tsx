      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="flex items-center space-x-3">
          <div className="flex space-x-2">
            ...
            <Button 
              size="sm"
              className="bg-rpp-red-main hover:bg-rpp-red-dark text-white hover:shadow-lg transition-all disabled:!opacity-100 disabled:!bg-rpp-grey-light disabled:cursor-not-allowed disabled:pointer-events-auto"
